  ...
  return (
    <>
      ...
      <main className="flex w-full flex-col items-center  h-full">
        {/* App Container ********************************************************************************/}
        <div className="flex flex-col shadow-2xl bg-[#121212ee] justify-center rounded-xl h-fit  w-[95%] md:w-[65%] xl:2/3 2xl:w-[40%] mt-2  md:mt-12  py-2 ">
          {/* Homepage Banner Image Container ************************************************************/}
          <div className="  flex justify-center">
            <Image
              priority
              className="w-2/3 md:w-[40%] h-fit"
              src={homepage_svg}
              alt="homepage search box image"
            />
          </div>
          {/* Search Box Container ***********************************************************************/}
          <div className="flex w-full mb-4  rounded-lg p-4 h-fit  ">
            <input
              ref={searchQueryRef}
              type="text"
              className="w-full bg-[#12121233] text-white text-whiterounded-lg text-md  md:text-xl p-2 outline-none border-[1px] border-purple-400 rounded-md  focus:border-[1px] focus:border-purple-500  "
